...
def add_to_favorite(request, anime_id):
    requests.get(
        f'http://127.0.0.1:8000/api/favorite/{anime_id}/{request.user.username}')
...
def add_to_watch_later(request, anime_id):
    requests.get(
        f'http://127.0.0.1:8000/api/watch_later/{anime_id}/{request.user.username}')
    return get_ranking(request, 100)
...
def add_to_watched(request, anime_id):
    requests.get(
        f'http://127.0.0.1:8000/api/watched/{anime_id}/{request.user.username}')
    return get_ranking(request, 100)
...
def get_favorites(request):
    serializer = AnimeSerializer()
    anime = requests.get(
        f'http://127.0.0.1:8000/api/favorites/{request.user.username}').json()
...
def get_watch_later(request):
    serializer = AnimeSerializer()
    anime = requests.get(
        f'http://127.0.0.1:8000/api/watch_later/{request.user.username}').json()
...
def get_watched(request):
    serializer = AnimeSerializer()
    anime = requests.get(
        f'http://127.0.0.1:8000/api/watched/{request.user.username}').json()
...
def remove_from_favorites(request, anime_id):
    requests.get(
        f'http://127.0.0.1:8000/api/favorites/remove/{anime_id}/{request.user.username}')
...
def remove_from_watch_later(request, anime_id):
    requests.get(
        f'http://127.0.0.1:8000/api/watch_later/remove/{anime_id}/{request.user.username}')
    return get_favorites(request)
...
def remove_from_watched(request, anime_id):
    requests.get(
        f'http://127.0.0.1:8000/api/watched/remove/{anime_id}/{request.user.username}')
    return get_favorites(request)
