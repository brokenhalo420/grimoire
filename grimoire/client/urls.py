...
urlpatterns = [
    ...
    path('watch_later/<int:anime_id>',
         views.add_to_watch_later, name="add_to_watch_later"),
    ...
    path('favorites/remove/<int:anime_id>',
         views.remove_from_favorites, name="remove_from_favorites"),
    path('watch_later/remove/<int:anime_id>',
         views.remove_from_watch_later, name="remove_from_watch_later"),
    path('watched/remove/<int:anime_id>',
         views.remove_from_watched, name="remove_from_watched"),
]
