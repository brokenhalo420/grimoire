...
urlpatterns = [
    ...
    path('watch_later/<int:anime_id>/<str:username>',
         views.add_anime_to_watch_later),
    ...
    path('favorites/remove/<int:anime_id>/<str:username>',
         views.remove_anime_from_favorites),
    path('watch_later/remove/<int:anime_id>/<str:username>',
         views.remove_anime_from_watch_later),
    path('watched/remove/<int:anime_id>/<str:username>',
         views.remove_anime_from_watched),
]
